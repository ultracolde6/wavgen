...
if __name__ == '__main__':
    ...
    if os.access(filename + '.h5', os.F_OK):  # ...retrieve the Waveforms from file.
        ...
        B = waveform.even_spacing(ntraps, int(102E6), int(2E6), phases=phases)  # ...the other with a useful constructor wrapper helper
        AB = waveform.Sweep(A, B, sweep_time=10)
