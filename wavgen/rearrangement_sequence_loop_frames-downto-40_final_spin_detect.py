...
if __name__ == '__main__':
    ...
    num_loops = 2 # number of times to additionally loop the AXA sequence. num_loops=1 means we do AXA twice in the sequence.
    ...
    #
    #
    # AXA_list = [['40_sweep4_to_5_antinode_HP.h5', '40_5L_antinode_HP.h5',
    #              '40_sweep5_to_4_antinode_HP.h5']]

    # AXA_list = [['40tweezers_sweep_to_5.5L_antinode.h5', '40tweezers_101.44center_5.5L_antinode.h5',
    #              '40tweezers_sweep_from_5.5L_antinode.h5']]
