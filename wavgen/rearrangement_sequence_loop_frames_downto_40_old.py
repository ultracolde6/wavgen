...
if __name__ == '__main__':
    ...
    tweezer_freq_list_drop = [startfreq + (ntraps-ntraps_drop+4)/2*spacing + j * spacing for j in range(ntraps_drop)]
...
######################initialize logger file####################################
    ...
    sort_list_L_drop = [f'sweep40newtweezers_{num}.h5' for num in range(1, ntraps_drop)]
    sort_list_R_drop = [f'sweep40newtweezers_{num}R.h5' for num in range(1, ntraps_drop)]
    # sort_list_L = ['70tweezers_101.44center.h5' for num in range(1, ntraps)]
    # sort_list_R = ['70tweezers_101.44center.h5' for num in range(1, ntraps)]
