...
if __name__ == '__main__':
    ...
    # eight lambda, thirty tweezers
    # path_folder = 'EightLambda-ThirtyTweezers'
    # spacing = 1.28
    # ntraps = 30
    # ntraps_drop = 30
    # CenterFreq = 101.44
    ...
    # ten lambda, thirty tweezers
    # path_folder = 'TenLambda-ThirtyTweezers'
    # spacing = 1.6
    # ntraps=30
    # ntraps_drop = 30
    # CenterFreq = 101.44
    ...
    # twelve lambda, twenty five tweezers
    path_folder = 'TwelveLambda-TwentyfiveTweezers'
    spacing = 1.92
    ntraps = 25
    ntraps_drop = 25
    CenterFreq = 101.44
    ...
    # path_folder = 'EighteenLambda-NineteenTweezers'
    # spacing = 0.16 * 18
    # ntraps = 19
    # ntraps_drop = 19
    # CenterFreq = 104.16
    ...
    # path_folder = '40tweezers_101.44center_4L.h5'
    ...
    num_loops = 5  # number of loops with rearrangement. Needs to be synced with jkam saving to fluo_images_delete_n
    if num_loops > 0:
    ...
    # wav_temp = utilities.from_file(Path(path_folder, 'static_new.h5'), 'A') # six lambda
    ...
    # wf_list_drop.append(utilities.from_file(Path(path_folder, 'static6.h5'), 'A')) # if not doing that, use this
    # wf_list_drop.append(utilities.from_file(Path(path_folder, 'sweep_6lambda_to_12_240us.h5'), 'A'))
    # wf_list_drop.append(utilities.from_file(Path(path_folder, 'static_new.h5'), 'A')) # if not doing that, use this
    # wf_list_drop.append(utilities.from_file(Path(path_folder, 'static_new.h5'), 'A'))
    wf_list_drop.append(utilities.from_file(Path(path_folder, 'static.h5'), 'A')) # if not doing that, use this
    wf_list_drop.append(utilities.from_file(Path(path_folder, 'static.h5'), 'A'))
    # wf_list_drop.append(utilities.from_file(Path(path_folder, 'static_5lambda.h5'), 'A'))
    # wf_list_drop.append(utilities.from_file(Path(path_folder, 'sweep_5lambda_to_16lambda_800us.h5'), 'A'))
