    ...
    def on_created(self, event):
        ...
        if path != self.last_created:
            ...
            ##################################################################
                ...
                if (self.current_time - self.previous_time > 10):
...
if __name__ == '__main__':
    ...
    # AX^NA G1 measurement sequence 06/26/2024
    # AXA_list = [
    #     ['sweep_5to5,5lambda_shifted_Lo4.h5', 'static_5,5lambda_shifted_Lo4_short.h5',
    ...
    # drop_list = ['drop_8.h5','drop_10.h5','drop_12.h5']
    # drop_list = ['drop_2_twz16,24.h5']
    drop_list = ['drop_1_twz28.h5','drop_1_twz12.h5','drop_1_twz20.h5','drop_1_twz28.h5','drop_1_twz35.h5']
    # drop_list = ['drop_1_twz16.h5','drop_1_twz24.h5']
    # drop_list = ['drop_20.h5']
    ...
    sort_list_L = [f'static.h5' for num in range(1, ntraps)]
    sort_list_R = [f'static.h5' for num in range(1, ntraps)]
