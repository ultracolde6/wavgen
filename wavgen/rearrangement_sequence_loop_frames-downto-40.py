...
if __name__ == '__main__':
    ...
    num_loops = 8 # number of times to additionally loop the AXA sequence. num_loops=1 means we do AXA twice in the sequence.
    if num_loops>0:
        multi_loop=True
    else:
        multi_loop=False
    ...
    # tweezer_freq_list_drop = [102.72 + j * 0.72 for j in range(-(ntraps_drop//2), ntraps_drop//2)]
    tweezer_freq_list_drop = [102.72 + j * 0.64 for j in range(-(ntraps_drop//2), ntraps_drop//2)]
