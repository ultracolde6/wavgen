from wavgen.waveform import Superposition, Sweep1, Sweep_loop
...
if __name__ == '__main__':
    ...
    # filename = 'sweep_loop_1-10_1-1ms_x3-10_quad'
    ...
    if os.access(filename + '.h5', os.F_OK):  # ...retrieve the Waveforms from file.
        ...
        AB = Sweep_loop(A, B, hold_time_1=100.0, hold_time_2=100.0, sweep_time=2.0, n_loops=1, ramp='quadratic')
