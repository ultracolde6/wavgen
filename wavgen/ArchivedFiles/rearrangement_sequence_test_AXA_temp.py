        ...
        if path != self.last_created:
            ...
            if 0 < atom_count:
                ...
                if multi_trig == True:
                    ...
                    llSegment = int(len(wf_list) - 1)  # 2 * num_tweezers + 2  # sweep back by Lo4
                    llLoop = 1
...
if __name__ == '__main__':
    ...
    AXA_list = [['sweep_to_half_shifted_Lo2_node_dualbias_Lo-64.h5', 'static_half-shifted_Lo2_dualbias_Lo-64.h5',
                           'sweep_from_half_shifted_Lo2_node_dualbias_Lo-64.h5']]
    flattened_AXA_list = [item for row in AXA_list for item in row]

    N_cycle = len(AXA_list)
