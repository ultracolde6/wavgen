...
if __name__ == '__main__':
    Lambda = 0.16E6
    CenterFreq = 104E6
    for fraction in [-3/320]:
    # for fraction in [0,-1/160,1/160,-1/128,1/128,-1/256,1/256,-1/320,1/320]:
    ...
    # for fraction in [1/64]:
        ...
        filename = Path(folder_name, f'static_5,5lambda_Spock_node_Delta={fraction}l.h5')
        ...
        if os.access(filename, os.F_OK):  # ...retrieve the Waveforms from file.
            ...
            freq_init = np.array([startfreq + com_shift + j * spacing + (-1)**j * spock_shift for j in range(ntraps)])
            ...
            phasesA = np.array([  0.32181742,  -0.70452607,   0.89978969,   1.7954116 ,
