        ...
        if path != self.last_created:
            ...
            ##################################################################
                if 0 < atom_count:
                    ...
                    if dont_sort_AXA:  # try to catch bug where empty_list_reduced is never defined
                        empty_list_reduced = [0, 1, 68, 69]
                    # now divide into left and right sides of the boundary
...
if __name__ == '__main__':
    ...
    num_loops = 1 # number of times to additionally loop the AXA sequence. num_loops=1 means we do AXA twice in the sequence.
