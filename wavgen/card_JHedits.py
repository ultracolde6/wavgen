...
class Card:
    ...
    def wiggle_output(self, duration=None, cam=None, block=True):
        ...
        spcm_dwGetParam_i32(self.hCard, SPC_TRIG_ORMASK, byref(a))
        ...
        spcm_dwSetParam_i32(self.hCard, SPC_TIMEOUT, int(10000))
    ...
    def sequence_replay(self, start_step, seg_size = 20000):
        ...
        max_segments = 8192 # what the caltech people use
        ...
        spcm_dwSetParam_i32(self.hCard, SPC_SEQMODE_SEGMENTSIZE, seg_size) # caltech people make all their segments multiples of 20us
        ...
        spcm_dwDefTransfer_i64(self.hCard, SPCM_BUF_DATA, SPCM_DIR_PCTOCARD, 0, pData, 0, seg_size*lBytesPerSample)
        # ^what is pData?
        ...
        # assumes buffer memory has been allocated and is already filled with valid data -- copy something from Aron's function for this?
        spcm_dwDefTransfer_i64(self.hCard, SPCM_BUF_DATA, SPCM_DIR_PCTOCARD, 0, pData, 0, seg_size/2 * lBytesPerSample)
        spcm_dwSetParam_i32(self.hCard, SPC_M2CMD, M2CMD_DATA_STARTDMA | M2CMD_DATA_WAITDMA)
    ...
    def _transfer_sequence(self, wavs, indices):
        ...
        if segs <= max(indices):
            ...
            spcm_dwSetParam_i32(self.hCard, SPC_SEQMODE_MAXSEGMENTS, segs) # caltech ppl use 8192 segments
