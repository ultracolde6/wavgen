...
if __name__ == '__main__':
    ...
    # four lambda, forty tweezers
    # path_folder = 'SixLambda-ThirtyTweezers'
    # spacing = 0.64
    # startfreq = 88.64
    # ntraps = 40
    # ntraps_drop = 40
    ...
    dont_sort_AXA = False # set this to be True only if we don't want per-loop sorting
    ...
    num_loops = 5 # number of times to additionally loop the AXA sequence. num_loops=1 means we do AXA twice in the sequence.

    mol_frame_before_sort = True
    mol_frame_after_sort = True
    ...
    if num_loops>0:
        ...
        multi_loop=False
#################
    # AXA_list = [['40tweezers_sweep_to_4L_blockade.h5','40tweezers_101.44center_blockade_4L_wide_v2.h5','40tweezers_sweep_from_4L_blockade.h5']] # use for blockaded interactions
    # AXA_list=[['40tweezers_sweep_to_8L_antinode_Rydberg.h5','40tweezers_101.44center_8L_antinode_rydberg.h5','40tweezers_sweep_from_8L_antinode_Rydberg.h5']] # use for single body
    AXA_list=[['30tweezers_sweep_to_8L_Rydberg.h5', 'static_eightlambda.h5','30tweezers_sweep_from_8L_Rydberg.h5']]
#####################




    # AXA_list = [['40tweezers_sweep_to_4L_blockade.h5','40tweezers_101.44center_4L.h5','40tweezers_sweep_from_4L_blockade.h5']]
    ...
    # drop_list = ['40tweezers_101.44center_4L_antinode.h5', '18tweezers_101.44center_4L.h5']
    ...
    tweezer_freq_list_drop = [101.44 + j * 0.96 for j in range(-(ntraps_drop//2), ntraps_drop//2)]
...
######################initialize logger file####################################
    ...
    sort_list_L_drop = [f'sweep30tweezersnew_{num}.h5' for num in range(1, ntraps_drop)]
    sort_list_R_drop = [f'sweep30tweezersnew_{num}R.h5' for num in range(1, ntraps_drop)]
    # sort_list_L = ['70tweezers_101.44center.h5' for num in range(1, ntraps)]
    # sort_list_R = ['70tweezers_101.44center.h5' for num in range(1, ntraps)]
